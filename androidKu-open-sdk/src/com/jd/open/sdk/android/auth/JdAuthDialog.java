...
public class JdAuthDialog extends Dialog {
	...
	public JdAuthDialog(Context context, String authUrl, String tokenUrl,
			String appId, String appSecret, JdListener.DialogListener listener) {
		super(context);
		mAuthUrl = authUrl;
		mTokenUrl = tokenUrl;
		mListener = listener;
	...
	private class JdWebViewClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			Logger.d("Jingdong-WebView", "Redirect URL: " + url);
		...
		public void onPageStarted(WebView view, String url, Bitmap favicon) {
			Logger.d("Jingdong-WebView", "Webview loading URL: " + url);
	...
	private class GetAccessTokenTask extends AsyncTask<String, Integer, Object> {
		...
		protected void onPostExecute(Object result) {
			...
			if (result instanceof Exception) {
				...
				bundle.putString(Constants.USER_NICK,json.optString(Constants.USER_NICK,""));
		...
		protected Object doInBackground(String... params) {
			...
			try {
				...
				Logger.e("Jingdong-WebView", "can not get access code: ", e);
				return e;
			}
		}
	}
