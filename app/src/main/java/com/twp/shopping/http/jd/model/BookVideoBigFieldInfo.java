...
public class BookVideoBigFieldInfo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2116985936612131198L;
	...
	public String toString() {
		return "BookVideoBigFieldInfo [comments=" + comments + ", image="
				+ image + ", content_desc=" + content_desc
				+ ", relatedProducts=" + relatedProducts + ", editer_desc="
				+ editer_desc + ", catalogue=" + catalogue + ", book_abstract="
