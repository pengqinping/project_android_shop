package com.twp.shopping.ui.menu.compat;
...
public final class ActionBarHelper {
	...
	public void setActionBarUpIndicator(Drawable drawable, int contentDesc) {
		if (mUsesCompat
				&& Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
			ActionBarHelperCompat.setActionBarUpIndicator(mIndicatorInfo,
					mActivity, drawable, contentDesc);
		} else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			ActionBarHelperNative.setActionBarUpIndicator(mIndicatorInfo,
					mActivity, drawable, contentDesc);
		}
	}
	...
	public void setActionBarDescription(int contentDesc) {
		if (mUsesCompat
				&& Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
			ActionBarHelperCompat.setActionBarDescription(mIndicatorInfo,
					mActivity, contentDesc);
		} else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			ActionBarHelperNative.setActionBarDescription(mIndicatorInfo,
					mActivity, contentDesc);
		}
	}
	...
	public Drawable getThemeUpIndicator() {
		if (mUsesCompat
			...
			return ActionBarHelperNative.getThemeUpIndicator(mIndicatorInfo,
					mActivity);
		}
	...
	public void setDisplayShowHomeAsUpEnabled(boolean enabled) {
		if (mUsesCompat
				&& Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
			ActionBarHelperCompat.setDisplayHomeAsUpEnabled(mIndicatorInfo,
					enabled);
		} else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
