 package com.twp.frame.request.data;   
 ...
 * @version V1.0   
 */
public class SimpleDownLoadTaskListener implements com.twp.frame.request.data.GalDownLoadTask.GalDownLoadTaskListener {
	Context mContext;
