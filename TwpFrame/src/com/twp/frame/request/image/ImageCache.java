...
package com.twp.frame.request.image;
...
public class ImageCache {
	 ...
	 * activity, final String uniqueName) { return findOrCreateCache(activity,
	 * new ImageCacheParams(uniqueName)); }
	 */
	...
	/*
	 * public static ImageCache findOrCreateCache(final FragmentActivity
	 * activity, ImageCacheParams cacheParams) {
	 * 
	 * // Search for, or create an instance of the non-UI RetainFragment final
	 ...
	 * 
	 * // No existing ImageCache, create one and store it in RetainFragment if
	 * (imageCache == null) { imageCache = new ImageCache(activity,
	 * cacheParams); mRetainFragment.setObject(imageCache); }
	 * 
	 * return imageCache; }
	 */
	/**
	...
	/**
	 * 异步线程中 下载完成后，会分别根据配置的参数把图片缓存到内存或者是disk;
	 * 
	 * @param data
	 * @param bitmap
	 */
